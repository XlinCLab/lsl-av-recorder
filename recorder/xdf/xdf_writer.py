...
FULL_BUFFER_BLOCK_THREAD_POLICY = "block"
FULL_BUFFER_DEFAULT_POLICY = FULL_BUFFER_DROP_OLDEST_POLICY
FULL_BUFFER_POLICIES = [
    FULL_BUFFER_DROP_OLDEST_POLICY,
    FULL_BUFFER_DROP_NEWEST_POLICY,
    FULL_BUFFER_BLOCK_THREAD_POLICY,
]
DEFAULT_WRITER_QUEUE_SIZE = 1000
DEFAULT_AUDIO_BUFFER_SECONDS = 0.0
DEFAULT_VIDEO_BUFFER_FRAMES = 0
